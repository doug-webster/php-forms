<?php
/**
 * models an HTML week input along with an associated label
 */

namespace GZMP\Form\FormElements;

class WeekInput extends \GZMP\Form\FormElements\Input
{
    use DateTimeInputValidator; // use trait

    private $date_format = 'Y-\WW';
    private $human_readable = 'YYYY-"W"WW';
