<?php
/**
 * models an HTML password input along with an associated label
 */

namespace GZMP\Form\FormElements;

class PasswordInput extends \GZMP\Form\FormElements\Input
{
    /**
    ...
    /**
     * it doesn't make sense to prepopulate password fields, so bypass this method
     */
